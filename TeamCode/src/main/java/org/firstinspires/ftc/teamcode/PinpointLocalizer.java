...
public final class PinpointLocalizer implements Localizer {
    public static class Params {
        public double parYTicks = -34.43366864379753; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -21.002904120071072; // x position of the perpendicular encoder (in tick units)
    }
